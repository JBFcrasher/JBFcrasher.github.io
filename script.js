...
let nitbtp2r="LazyComet"; let nitbtp2c="Lazy Comet"; let nitbtp2t="1:41.99"; let nitbtp2a="https://www.twitch.tv/videos/1484363654";var myElementnitbtp2 = document.getElementById("nitbtp2");if(myElementnitbtp2){ document.getElementById("nitbtp2l").textContent = nitbtp2t;document.getElementById("nitbtp2").classList.add(nitbtp2r);}var myElementnitbtp2p = document.getElementById("nitbtp2p");if(myElementnitbtp2p){ document.getElementById("nitbtp2d").textContent = nitbtp2t;document.getElementById("nitbtp2p").classList.add(nitbtp2r);var a = document.getElementById('nitbtp2d');a.href = nitbtp2a;document.getElementById("nitbtp2r").textContent = nitbtp2c}
